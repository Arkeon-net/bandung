          ...
          <div class="carousel-inner"> 
            ...
            <div class="item active">
              <div class="row box-product"> 
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                  <div class="product-block">
                    <div class="image"> <a class="img" href="product.html"><img alt="product info" src="<?php echo base_url(); ?>static/images/products/product2.jpg" title="product title"></a> </div>
                    <div class="product-meta">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                  <div class="product-block">
                    <div class="image">
                      ...
                      <a class="img" href="product.html"><img alt="product info" src="<?php echo base_url(); ?>static/images/products/product3.jpg" title="product title"></a> </div>
                    <div class="product-meta">
      ...
      <div class="box-content">
        <div class="box-products slide carousel-fade" id="productc2">
          ...
          <div class="carousel-inner"> 
            ...
            <div class="item">
              <div class="product-block">
                <div class="image"> <a class="img" href="product.html"><img alt="product info" src="<?php echo base_url(); ?>static/images/products/product3.jpg" title="product title"></a> </div>
                <div class="product-meta">
            ...
            <div class="carousel-inner"> 
              ...
              <div class="blog-entry item">
                <div class="image"> <span class="blogico"> <i class="fa fa-bullhorn fa-fw"></i><br>
                  Blog entry</span> <img class="ani-image" src="<?php echo base_url(); ?>static/images/blog-4.jpg" alt="image info"> </div>
                <div class="entry-row">
              ...
              <div class="blog-entry item">
                <div class="image"> <span class="blogico"> <i class="fa fa-bullhorn fa-fw"></i><br>
                  Blog entry</span> <img class="ani-image" src="<?php echo base_url(); ?>static/images/blog-1.jpg" alt=""> </div>
                <div class="entry-row">
              ...
              <div class="blog-entry item active">
                <div class="image"> <span class="blogico"> <i class="fa fa-bullhorn fa-fw"></i><br>
                  Blog entry</span> <img class="ani-image" src="<?php echo base_url(); ?>static/images/blog-2.jpg" alt=""> </div>
                <div class="entry-row">
              ...
              <div class="blog-entry item">
                <div class="image"> <span class="blogico"> <i class="fa fa-bullhorn fa-fw"></i><br>
                  Blog entry</span> <img class="ani-image" src="<?php echo base_url(); ?>static/images/blog-3.jpg" alt=""> </div>
                <div class="entry-row">
            ...
            <div class="box-products box-brands slide" id="brands">
              ...
              <div class="carousel-inner">
                <div class="brands-row item active">
                  <div class="brand-logo"><a href="#a"><img src="<?php echo base_url(); ?>static/images/brands/logo1.png" alt=""></a></div>
                  <div class="brand-logo"><a href="#a"><img src="<?php echo base_url(); ?>static/images/brands/logo2.png" alt=""></a></div>
                  <div class="brand-logo"><a href="#a"><img src="<?php echo base_url(); ?>static/images/brands/logo3.png" alt=""></a></div>
                  <div class="brand-logo"><a href="#a"><img src="<?php echo base_url(); ?>static/images/brands/logo1.png" alt=""></a></div>
                </div>
